...
//
const BotName = 'BOT RUBYCLOWN🌷'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/danizx_666'; // Nama Instagramlu cok
const whatsapplu = '082322427684'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/EMm6EdyM3FE7XyIVD5BgmY'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/EMm6EdyM3FE7XyIVD5BgmY'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
